# 신약의 작용 메커니즘 예측 \| 차근차근 완벽한 설명 \| EDA에서 앙상블까지

Assign: Chanran Kim  
Status: Completed   
날짜: 2020년 12월 13일   
키워드: Adversarial Validation, Feature Scaling, K-means Clustering, PCA, Statistical Feature, Variance Threshold   
타입: 노트북 리뷰

## Introduction

* Silver Medal, 47th  Team
